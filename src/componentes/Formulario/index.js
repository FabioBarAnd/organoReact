...
const Formulario = (props) => {
    ...
    const aoSalvar = (evento) => {
        evento.preventDefault(); //evita o comportamento padrão de recarregar a página(algo do tipo)
    ...
    return(
        <section className="formulario">
            <form onSubmit={aoSalvar}>
                ...
                <ListaSuspensa label="Time" item={props.nomesDosTimes} valor={time} aoAlterado={valor => setTime(valor)}/>
